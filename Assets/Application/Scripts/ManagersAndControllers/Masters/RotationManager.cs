...
namespace LabirinthGame.Managers
{
    ...
    public class RotationManager : ScriptableObject, IRotator
    {
        ...
        private PlayerLoopSubscriptionController _playerLoopSubscriptionController = new PlayerLoopSubscriptionController();
        ...
        {
            Rotate(_rotateblesAtUpdate, fixedDeltaTime);
        }
        ...
        public void Initialize(IPlayerLoopProcessor playerLoopProcessor)
        {
            ...
            _playerLoopSubscriptionController.Initialize(this, playerLoopProcessor);
            _playerLoopSubscriptionController.SubscribeToLoop();
        }
